...
### D-006 (Template repo defaults should be explicit, not UNCONFIRMED)
- Status: ACTIVE
- Date: 2026-02-08
- Decision: For this starter repository, replace project command/context placeholders with explicit `N/A` or concrete maintenance commands once repository purpose is clear.
- Why: Leaving placeholders in the starter baseline creates avoidable ambiguity and slows first-use setup.
- Impact: `AGENTS.md`, `/.agent/CONTEXT.md`, and `/.agent/RUNBOOK.md` should be kept concrete for this template and updated when repository scope changes.
