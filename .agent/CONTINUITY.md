...
## Done (recent)
- `YYYY-MM-DD` `[TAG]` concise completed item.

## Working set
- `YYYY-MM-DD` `[TAG]` current in-progress context.

## Decisions
- `YYYY-MM-DD` `[TAG]` pointer to `DECISIONS.md` entry.

## Receipts
- `YYYY-MM-DD` `[TAG]` command/file/test receipt.
